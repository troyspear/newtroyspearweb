...
const socialLinks = [
  { href: 'https://www.instagram.com/troy.spear', label: 'Instagram', icon: InstagramIcon },
  { href: 'https://www.youtube.com/@TroySPEAR', label: 'YouTube', icon: YoutubeIcon },
