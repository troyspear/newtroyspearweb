...
export default function Navbar({ onSearchOpen }: { onSearchOpen: () => void }) {
  ...
  return (
    <>
      <nav aria-label="Main navigation" className="fixed top-0 left-0 right-0 z-50 bg-page/95 dark:bg-page/70 backdrop-blur-xl border-b border-glass-border">
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {dark !== null && (
                <button
                  onClick={toggleDark}
                  className="text-fg-muted hover:text-fg transition-colors p-1.5 -m-1.5"
                  aria-label="Toggle dark mode"
                >
                  {dark ? <Sun className="w-5 h-5 sm:w-4 sm:h-4" /> : <Moon className="w-5 h-5 sm:w-4 sm:h-4" />}
                </button>
              )}
              <button
              ...
              <button
                ...
                className="md:hidden text-fg-muted hover:text-fg transition-colors p-1.5 -m-1.5"
